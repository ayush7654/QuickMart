...
const cardsList = [
  ...
  { id: 0, name: 'Technology',video:'technology-vid.mp4',snap:'technology-snap.jpg', thumbnail:'technology-tn.jpg', path:'',  heading: { l1: 'Next generation', l2: 'innovation in your', l3: 'hands.' }},
      { id: 1,  name: 'Clothing', video:'clothing-vid.mp4', snap:'clothing-snap.jpg', thumbnail:'clothing-tn.jpg',  path:'', heading: { l1: 'Signature styles', l2: ' for every personal', l3: 'journey.' } },
      { id:2,  name: 'Decor',video:'decor-vid.mp4',snap:'decor-snap.jpg', thumbnail:'decor-tn.jpg',  path:'',  heading: { l1: 'Refining the art of', l2: 'living well.', l3: '' }},
        { id: 3,  name: 'Adventure',video:'adventure-vid.mp4',snap:'adventure-snap.jpg', thumbnail:'adventure-tn.jpg',  path:'',  heading: { l1: 'Every journey', l2: 'begins with better', l3: ' gear.' } },
          ...
          { id: 5,name: 'Essentials',video:'grocery-vid.mp4',snap:'grocery-snap.jpg', thumbnail:'grocery-tn.jpg', path:'',  heading: { l1: 'Quality essentials', l2: 'for your daily', l3: 'routine.' }},
...
export default function ExploreCategory() {
  ...
  <div className="cursor-arrows">
      ...
      <div className="test-carousel-viewport">
        ...
        <div className="test-carousel-window">
          <div
        ...
        return (
          ...
          <div className='category-nav'>
             <div className='category-nav-btn' onClick={handlePrev}>
              <FiChevronLeft size={30} />
             </div>
               <div className='category-nav-btn' onClick={handleNext}>
              <FiChevronRight size={30} />
             </div>
          </div>     
    </div>  
    <div className="category-dot-nav">
