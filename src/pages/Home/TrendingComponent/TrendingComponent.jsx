...
export default function TrendingComponent() {
  return (
      <div className="trending-products-div">
         <div className="trending-products-heading-div" ><div className='trending-products-heading'>Trends In Fashion -<span className="home-Products-tagline"> &nbsp; Style That Speaks Today</span></div></div>
