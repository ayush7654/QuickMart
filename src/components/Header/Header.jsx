    ...
    return(<div className="sticky-header">
        ...
        <div className="header-searchBar-div" >
         ...
         <div className='Home-Nav-Container'>
            {elements.map((element,index)=> <NavLink   key={index} className={({isActive})=>isActive?'navlink-selected':'navlink'} to={element.path}> <img src={`public/${element.logo}.png`} width='20px'/><div>{element.title}</div></NavLink>)}
         </div>
